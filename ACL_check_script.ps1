...
Foreach ($exe in $exek){
    Write-Host ""
    Write-Host "EXE:`t" $exe -ForegroundColor Black -BackgroundColor Green
    ...
    Foreach ($acl in $acls){
        ...
        elseif ($myObject.IdentityReference -match "reade" -Or $myObject.IdentityReference -match "czytel") {
            ...
            Write-Host "`tIdentity Reference: " $myObject.IdentityReference -ForegroundColor Black -BackgroundColor Yellow
        }
        else{
            ...
            Write-Host "`tIdentity Reference: " $myObject.IdentityReference -ForegroundColor Black -BackgroundColor Red
        }
    }
}
